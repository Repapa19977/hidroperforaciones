 ...
 * Fuente: INE / Ministerio de Gobernación (división política oficial).
 */
export const GT_DEPARTAMENTOS: Record<string, string[]> = {
  ...
  'Guatemala': [
    'Guatemala', 'Mixco', 'Villa Nueva', 'Villa Canales', 'Petapa',
    'San Miguel Petapa', 'Santa Catarina Pinula', 'San José Pinula', 'San José del Golfo',
    'Palencia', 'Chinautla', 'San Pedro Ayampuc', 'San Pedro Sacatepéquez',
  ...
  'Quiché': [
    ...
    'San Juan Cotzal', 'Joyabaj', 'Nebaj', 'San Andrés Sajcabajá', 'Uspantán',
    'Sacapulas', 'San Bartolomé Jocotenango', 'Canillá', 'Chicamán', 'Ixcán',
    'Pachalum',
  ],
  'Retalhuleu': [
...
export const DEPARTAMENTOS_GT = Object.keys(GT_DEPARTAMENTOS).sort()
